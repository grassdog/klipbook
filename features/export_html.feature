Feature: klipbook outputs the clippings from a clippings file into a set of HTML files
  ...
  Scenario: File with clippings for a book
    ...
    Then I should find a "html" file in the folder "output" named "Lean Software Development: An Agile Toolkit by Mary Poppendieck and Tom Poppendieck.html" that contains "13" clippings
    Then I should find a "html" file in the folder "output" named "Instapaper: Long Reads by Instapaper: Long Reads.html" that contains "4" clippings
    Then I should find a "html" file in the folder "output" named "Clean Code: A Handbook of Agile Software Craftsmanship by Robert C. Martin.html" that contains "3" clippings
